...
describe('IsoDate', () => {
  ...
  describe('parse', () => {
    ...
    it('returns null if date is not parsable', () => {
      expect(IsoDate.parse('horse')).toEqual(null);
    });
  });
});
...
describe('IsoDateTime', () => {
  ...
  describe('parse', () => {
    ...
    it('returns null if datetime is not parsable', () => {
      expect(IsoDateTime.parse('horse')).toEqual(null);
    });
  });
});
